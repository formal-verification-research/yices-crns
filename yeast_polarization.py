...
R2 = Terms.implies(Terms.arith_geq_atom(R, one), Terms.sub(nexts[R], one))
print("type of sub is ", Terms.type_of_term(Terms.sub(nexts[R], one)))
print("type of arith_geq_atom is ", Terms.type_of_term(Terms.arith_geq_atom(R, one)))
R3 = Terms.implies(Terms.yand([Terms.arith_geq_atom(L, one), Terms.arithm_geq_atom(R, one)]),
...
GOAL = Terms.arith_q_atom(GBG, Terms.rational(50, 1))
